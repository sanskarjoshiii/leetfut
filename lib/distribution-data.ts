// Rating histogram used by the "where you stand" panel. NOTE: this is currently
// a PLACEHOLDER distribution carried over from the original engine's sample —
// regenerate it against a real sample of LeetCode profiles for accurate
// percentiles. The data lives in data/distribution-data.json; this module only
