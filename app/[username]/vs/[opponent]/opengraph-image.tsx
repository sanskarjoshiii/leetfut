...
export const alt =
  "LeetFut Scout Duel — two player cards facing off across a lightning strike";
      ...
      (
        <div
          style={{
            ...
            background: "#060605",
            backgroundImage:
              "radial-gradient(520px 300px at 50% -8%, rgba(255,246,230,0.12), transparent 60%), radial-gradient(760px 200px at 50% 103%, rgba(255,161,22,0.18), transparent 70%)",
            color: "#f5f5f4",
            fontFamily: "DINPro",
            textAlign: "center",
            padding: 64,
        ...
        >
          ...
          <div
            style={{ display: "flex", fontSize: 30, color: "#a8a29e", marginTop: 18 }}
          >
            watch the duel at
          </div>
          <div
    ...
    (
      <div
        style={{
          ...
          backgroundImage: [
            "radial-gradient(520px 300px at 50% -8%, rgba(255,246,230,0.12), transparent 60%)",
