...
export function Tip({
  ...
  return (
    <span className="group/tip relative inline-flex cursor-help items-center">
      ...
      <span
        role="tooltip"
        className={`pointer-events-none absolute bottom-full ${pos} z-30 mb-2 hidden w-max max-w-[220px] whitespace-normal rounded-lg border border-white/10 bg-[#1e1c1a] px-3 py-2 text-left text-[12px] font-normal leading-snug text-ink-dim shadow-[0_10px_30px_rgba(0,0,0,.55)] group-hover/tip:block`}
      >
        {text}
      </span>
    </span>
            ...
            <Tip text={p.reason} align="left">
              ...
              {p.plus && (
                <span
                  ...
                  style={{ background: accent, color: "#0c0b0a" }}
                  title="PlayStyle+"
                >
                  +
                </span>
      ...
      <Stagger step={0} className="shrink-0">
        <div
          ...
          style={{
            ...
            background: `linear-gradient(160deg, ${accent}1a, transparent 70%), #151412`,
      ...
      <div className="min-w-0 flex-1 text-left">
        <Stagger step={1} className="relative">
          ...
          <h2
            ...
            style={{
              backgroundImage: `linear-gradient(100deg, #f5f5f4 0%, #f5f5f4 38%, ${accent} 50%, #fff 54%, #f5f5f4 64%, #f5f5f4 100%)`,
        ...
        <Stagger step={2}>
          <div className="mt-[8px] flex flex-wrap items-center gap-x-[10px] gap-y-[6px]">
            ...
            <span className="inline-flex flex-wrap items-center gap-x-[10px] gap-y-[6px]">
              <a
                href={`https://leetcode.com/u/${card.login}/`}
                target="_blank"
