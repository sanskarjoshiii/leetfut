...
// The six LeetCode signals behind each stat — accurate to the engine (labels
// are LeetCode's, the internal keys stay pac/sho/pas/dri/def/phy).
const READS = [
  { abbr: "CNS", gloss: "Your streak and days active over the year" },
  { abbr: "HRD", gloss: "Hard problems solved, and how deep you go" },
  { abbr: "CTS", gloss: "Your contest rating and contests played" },
  { abbr: "VER", gloss: "Your topic & language range — broad helps, but the 10th counts for less" },
  { abbr: "ACC", gloss: "Your acceptance rate across submissions" },
  { abbr: "VOL", gloss: "A lifetime of problems solved over your active years" },
];
    ...
    >
      ...
      >
        ...
        <p className="m-0 mt-[15px] max-w-[47ch] text-[14.5px] leading-[1.55] text-ink-dim">
          Six signals off your live LeetCode profile, weighed against each other to find your shape. That shape is your
          card — so two solvers with the same numbers still walk out different. Here&apos;s how to read yours.
        </p>
        ...
        <div className="mt-[24px] border-t border-white/[0.08] pt-[20px]">
          ...
          <p className="m-0 mt-[16px] text-[12px] leading-[1.5] text-ink-mute">
            Read live from your public LeetCode profile — solves, contests, streaks and earned
            badges. No inputs, no edits — just the tape.
          </p>
        </div>
      </div>
    </div>
