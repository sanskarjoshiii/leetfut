...
export default function ScoutForm({
  ...
  return (
    <div className="min-w-0 flex-1">
      ...
      <h1 className="font-fantasy m-0 mb-4 text-[clamp(38px,5.4vw,80px)] font-bold leading-[1.02] tracking-[.015em]">
